        ...
        <div className={styles.parent_container}>
            <div className={styles.inner_container}>
                <p>
                    ...
                    extent of their injuries. Over the last decade, RWRC has provided medical treatment and care for
                    more than forty thousand birds. The majority of birds that we receive come to us with
                    life-threatening injuries as a result of animal attacks, nest displacement (orphaned), automobile
                    strikes, natural/man-made disasters, or abuse. RWRC is entirely dependent on dedicated volunteers
                    and private donations, as it does not receive any federal, state, or local government funding for
                    its rehabilitation and conservation efforts.
                </p>
            </div>
        </div>
    );
